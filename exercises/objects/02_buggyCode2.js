...
// function. Then, modify the code so that it produces the correct
// results.
...
const item = {
  ...
  discount(percent) {
    ...
    // This line is permanently changing the price of this object
    // this.price -= discount;

    // return this.price;

    // We should instead return the new price without modifying the original
    // price
